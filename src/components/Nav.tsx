...
export default function Nav({ itemsInCart }: NavProps) {
  ...
  return (
    <div className="w-[15vw] h-[56px] w-[256px] mx-auto mb-4 bg-black rounded-4xl flex items-center cursor-pointer">
      ...
      <div className="flex">
        ...
        <Link
          to="cart"
          className="cursor-pointer px-2 hover:text-[#00C853] transition"
        >
          Cart
        </Link>
      </div>
